...
public enum PaymentOrderStatus {
  ...
  public String abbreviation() {return (String) values[1];}
  public String description() {return (String) values[2];}
  public OrderStatus commandModelStatus() {return (OrderStatus) values [3];}
}
